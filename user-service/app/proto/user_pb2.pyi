...
class RegisterResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[_Union[User, _Mapping]] = ..., error: _Optional[_Union[ValidationError, _Mapping]] = ...) -> None: ...
...
class LoginResponse(_message.Message):
    ...
    success: UserToken
    error: ValidationError
    def __init__(self, success: _Optional[_Union[UserToken, _Mapping]] = ..., error: _Optional[_Union[ValidationError, _Mapping]] = ...) -> None: ...
...
class User(_message.Message):
    __slots__ = ("id", "created_at", "updated_at", "email", "first_name", "last_name", "properties", "is_active", "platform_id")
...
class UpdateRequest(_message.Message):
    __slots__ = ("id", "email", "password", "password_confirm", "first_name", "last_name", "is_active")
    ID_FIELD_NUMBER: _ClassVar[int]
    EMAIL_FIELD_NUMBER: _ClassVar[int]
    PASSWORD_FIELD_NUMBER: _ClassVar[int]
    PASSWORD_CONFIRM_FIELD_NUMBER: _ClassVar[int]
    ...
    last_name: str
    is_active: bool
    def __init__(self, id: _Optional[str] = ..., email: _Optional[str] = ..., password: _Optional[str] = ..., password_confirm: _Optional[str] = ..., first_name: _Optional[str] = ..., last_name: _Optional[str] = ..., is_active: bool = ...) -> None: ...
