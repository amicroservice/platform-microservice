...
import grpc
from services.admin_invite import AdminInviteService
...
async def serve():
    app_name = os.getenv("APP_NAME", "admin-invite-service")
    ...
    invite_service = AdminInviteService(
    ...
    admin_invite_pb2_grpc.add_AdminInviteServiceServicer_to_server(
        invite_service, server
    )
