...
"""Test configuration for platform-service tests.

This file intentionally omits the project license header; keep it minimal
so tests load quickly.
"""

import os
import sys

# Ensure the platform-service directory is on sys.path so `import app` works
